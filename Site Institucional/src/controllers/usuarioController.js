                ...
                function (resultadoAutenticar) {
                    ...
                    if (resultadoAutenticar.length == 1) {
                        ...
                        res.json({
                            ...
                            fk_tipo_usuario: resultadoAutenticar[0].fk_tipo_usuario
                        });
...
function cadastrar(req, res) {
    ...
    var fk_tipo_usuario = req.body.fk_tipo_usuarioServer;
    ...
    } else if (fk_tipo_usuario == undefined) {
        res.status(400).send("Sua empresa a vincular está undefined!");
    } else {

        // Passe os valores como parâmetro e vá para o arquivo usuarioModel.js
        usuarioModel.cadastrar(nome, email, senha, cpf, fk_tipo_usuario)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
...
function atribuir(req, res) {
    ...
    usuarioModel.deletar(idUsuario)
        .then(
            ...
            function (erro) {
                console.log(erro);
                console.log("Houve um erro ao deletar o usuário! Erro: ", erro.sqlMessage);
                res.status(500).json(erro.sqlMessage);
            }
        );
}
